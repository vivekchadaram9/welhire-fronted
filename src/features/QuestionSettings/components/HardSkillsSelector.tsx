// src/features/QuestionSettings/QuickSetup/components/HardSkillsSelector.tsx
...
export default function HardSkillsSelector({ items, levels, selected, onToggle, onLevelChange }: Props) {
  return (
    <Paper
      elevation={0}
      sx={{
